...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log("Fetching SMS chat sessions from:", url.toString());
    ...
    if (!response.ok) {
      ...
      return NextResponse.json(
        { success: false, error: "Failed to fetch SMS chat sessions" },
    ...
    console.error("Error fetching SMS chat sessions:", error);
    return NextResponse.json(
